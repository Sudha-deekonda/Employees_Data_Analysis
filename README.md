...
![image](https://github.com/user-attachments/assets/6d99f49e-102a-4c5e-b053-e43d5011cca1)
...
![image](https://github.com/user-attachments/assets/d8e9d18e-1502-4160-a8d4-b68437bdcc8a)

The query produced the following result

![image](https://github.com/user-attachments/assets/0bf69fe6-6206-46b1-aee3-4d7b4f38489e)
...
For this, we should join employees, dept_manager, departments tables. We used CASE statement to get an additional column which shows when the employee was serving as manager. Here, 1 indicates active and 0 when employee is not manager. We also created sub query (inner query) where we joined all the required tables.

![image](https://github.com/user-attachments/assets/07a1dc06-ebc9-4664-927f-ba2c1c5b9a9e)

The query produced the following result

![image](https://github.com/user-attachments/assets/cd0631b4-b200-4347-9ea2-7f6700c23cc2)
...
![image](https://github.com/user-attachments/assets/f2f01223-2ab8-4578-b350-6329477d5a36)

The query produced the following result

![image](https://github.com/user-attachments/assets/e6cf0048-5908-4d05-9f86-0eab4af23242)
...
![image](https://github.com/user-attachments/assets/1a589e4a-c64c-4726-b196-de88a708ba7c)

The query produced the following result

![image](https://github.com/user-attachments/assets/2ec785de-56ee-4bff-9862-58b146414cf9)
...
![image](https://github.com/user-attachments/assets/3eba2968-74ee-4099-bb20-78c7877850dc)
